...
const StyledCustomSwitch = styled(Switch, {
  ...
  theme,
  darkThemeTrackBackgroundColor,
  lightThemeTrackBackgroundColor,
  darkThemeSwitchThumbColor,
  lightThemeSwitchThumbColor,
  textColor
}) => ({
  width: 62,
  height: 34,
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? darkThemeTrackBackgroundColor : lightThemeTrackBackgroundColor,
      },
    },
  },

  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? darkThemeSwitchThumbColor : lightThemeSwitchThumbColor,
    width: 32,
    height: 32,
...
export default StyledCustomSwitch;
